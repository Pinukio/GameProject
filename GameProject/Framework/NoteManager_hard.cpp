...
NoteManager_hard::NoteManager_hard()
	:GameObject()
{
	...
	keyManager = (KeyManager*)Scene::GetCurrentScene().PushBackGameObject(new KeyManager());
...
void NoteManager_hard::createNote(unsigned short position)
{
	switch (position)
	{
	case 0:
...
void NoteManager_hard::reverseNote(unsigned short position)
{
	switch (position)
	{
